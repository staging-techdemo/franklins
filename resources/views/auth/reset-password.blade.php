...
<head>
    ...
    <title>Reset Password – Franklin's Forever Care</title>
    ...
    <div class="w-full max-w-[440px]">
        <div class="bg-white rounded-[14px] border border-[#e2e8f0] shadow-[0_4px_24px_rgba(26,60,220,0.12)] p-9">
            <div class="text-center mb-7">
                ...
                <div class="text-[13px] text-[#64748b] mt-1">Your identity is verified. Create a strong new password.</div>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="mb-4">
                    <label class="block text-[13px] font-semibold text-[#1e293b] mb-1.5" for="password">New Password</label>
                    <div class="relative">
                        ...
                        <input class="w-full pl-9 pr-3 py-2.5 border-[1.5px] border-[#e2e8f0] rounded-[9px] text-[13.5px] text-[#1e293b] bg-white outline-none transition focus:border-[#1a3cdc] focus:shadow-[0_0_0_3px_rgba(26,60,220,0.08)] placeholder-[#64748b]" 
                            type="password" id="password" name="password" placeholder="••••••••" required autofocus />
                    </div>
                </div>

                <div class="mb-8">
                    <label class="block text-[13px] font-semibold text-[#1e293b] mb-1.5" for="password_confirmation">Confirm Password</label>
                    <div class="relative">
                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-[#64748b] pointer-events-none">
                            <svg class="w-[15px] h-[15px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <rect width="18" height="11" x="3" y="11" rx="2" ry="2" />
