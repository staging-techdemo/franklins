...
@section('admin-content')
    <div class="w-full mb-5">
        <div class="text-2xl font-extrabold text-theme-text-main">Create New Category</div>
        <div class="text-[13px] text-theme-text-muted mt-1">Add a new category for content organization.</div>
    </div>
