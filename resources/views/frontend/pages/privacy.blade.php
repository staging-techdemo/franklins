            ...
            <div class="max-w-4xl mx-auto bg-white rounded-3xl p-12 shadow-sm border border-gray-100">
                ...
                <div class="prose prose-lg max-w-none text-[#666666] space-y-6">
                    <section>
                        ...
                        <p>Welcome to Franklin's Forever Care. We respect your privacy and are committed to protecting your
                            personal data. This privacy policy will inform you about how we look after your personal data
                            when you visit our website and tell you about your privacy rights and how the law protects you.
                        </p>
                    </section>

                    <section>
                        <h2 class="text-2xl font-bold text-black mb-4">2. The Data We Collect About You</h2>
                        <p>Personal data, or personal information, means any information about an individual from which that
                            person can be identified. We may collect, use, store and transfer different kinds of personal
                        ...
                        <ul class="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>Usage Data:</strong> includes information about how you use our website, products
                                and services.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 class="text-2xl font-bold text-black mb-4">3. How We Use Your Personal Data</h2>
                    ...
                    <section>
                        <h2 class="text-2xl font-bold text-black mb-4">4. Data Security</h2>
                    ...
                    <section>
                        <h2 class="text-2xl font-bold text-black mb-4">5. Your Legal Rights</h2>
                        <p>Under certain circumstances, you have rights under data protection laws in relation to your
                            ...
                            processing is consent) to withdraw consent.</p>
                    </section>
