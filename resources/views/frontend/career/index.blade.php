...
@section('title', 'Join Our Care Team')

@section('content')
<div class="pt-[160px] pb-20">
            ...
            <div class="grid grid-cols-2 gap-16 items-center lg:grid-cols-1">
                <div class="space-y-6">
                    ...
                    <p class="text-[#666666] font-medium paragraph leading-normal">
                        At Franklin's Forever Care, we are always looking for dedicated, compassionate, and professional individuals to join our care team. If you have a passion for providing high-quality care and want to make a difference in the lives of seniors, we'd love to hear from you.
                    </p>
                    <div class="space-y-4 pt-4">
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-full bg-[#DDEEE7] flex items-center justify-center shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#4A9D7A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                            </div>
                            <div>
                                <h4 class="font-bold text-black">Competitive Compensation</h4>
                                <p class="text-gray-500 smallParagraph">We offer industry-leading pay and benefits to our valued team members.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-full bg-[#F6ECD9] flex items-center justify-center shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[#DFA15B]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <div>
                                <h4 class="font-bold text-black">Flexible Scheduling</h4>
                                <p class="text-gray-500 smallParagraph">Work schedules that respect your work-life balance and personal needs.</p>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="bg-gradient-to-br from-[#DDEEE7] to-[#F6ECD9] rounded-3xl p-10 shadow-sm border border-white">
                    ...
                    <form action="{{ route('career.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 sm:grid-cols-1">
                            <div class="space-y-1.5">
                                <label class="text-xs font-bold uppercase tracking-wider text-gray-500 ml-1">Full Name</label>
                                <input type="text" name="full_name" value="{{ old('full_name') }}" required placeholder="e.g. John Doe"
                                    class="w-full h-14 rounded-xl border-0 bg-white px-5 outline-none focus:ring-2 focus:ring-[#7E80B0] transition-all">
                                @error('full_name') <p class="text-red-500 text-[11px] ml-1">{{ $message }}</p> @enderror
                            </div>
                            <div class="space-y-1.5">
                        ...
                        <div class="grid grid-cols-2 gap-4 sm:grid-cols-1">
                            <div class="space-y-1.5">
                                <label class="text-xs font-bold uppercase tracking-wider text-gray-500 ml-1">Phone Number</label>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="address" value="{{ old('address') }}" required placeholder="123 Main St, Apt 4B"
                                class="w-full h-14 rounded-xl border-0 bg-white px-5 outline-none focus:ring-2 focus:ring-[#7E80B0] transition-all">
                        ...
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold uppercase tracking-wider text-gray-500 ml-1">Your Experience / Message</label>
